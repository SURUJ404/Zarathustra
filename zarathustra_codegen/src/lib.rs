...
use std::ops::*;
use zarathustra_ast::common::embed::*;
use zarathustra_ast::common::FlatEmbed;
use zarathustra_ast::common::WithSpan;
use zarathustra_ast::common::{flat::Variable, RuntimeError};
use zarathustra_ast::flat::*;
use zarathustra_ast::ir::Solver;
use zarathustra_ast::zir::types::{Type, UBitwidth};
...
impl<'ast, T: Field> Flattener<'ast, T> {
    ...
    fn enforce_naive_assertion(
        ...
        error: zarathustra_ast::zir::RuntimeError,
    ) {
...
mod tests {
    use super::*;
    use zarathustra_ast::zir;
    use zarathustra_ast::zir::types::Signature;
    use zarathustra_ast::zir::types::Type;
    use zarathustra_ast::zir::Id;
    use zarathustra_ast::zir::ZirFunction;
