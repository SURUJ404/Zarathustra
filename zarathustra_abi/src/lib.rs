...
use std::fmt;
use zarathustra_ast::typed::types::{ConcreteType, UBitwidth};
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Error::Conversion(e) => write!(f, "Invalid Zarathustra values: {}", e),
...
mod tests {
    use super::*;
    use zarathustra_ast::typed::types::{ConcreteStructMember, ConcreteStructType, ConcreteType};
