...
use zarathustra_common::constants;
use zarathustra_common::helpers::*;
    ...
    match parameters {
        ...
        Parameters(BackendParameter::Ark, _, SchemeParameter::MARLIN) => {
            ...
            let setup_file = File::open(setup_path)
                .map_err(|why| format!("Couldn't open {}: {}\nExpected an universal setup, make sure `zarathustra universal-setup` was run`", setup_path.display(), why))?;
