...
## [Unreleased]
https://github.com/Zarathustra/Zarathustra/compare/latest...develop

## [0.8.7] - 2023-04-22

### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.8.7 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.8.6 <!-- markdown-link-check-disable-line -->

### Changes
- Make Zarathustra build on stable rust (#1288, @schaeff)
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.8.5 <!-- markdown-link-check-disable-line -->
...
- Fix a potential crash in `zarathustra-js` due to inefficient serialization of a setup keypair (#1277, @dark64)
- Show help when running `zarathustra mpc` (#1275, @dark64)

## [0.8.4] - 2023-01-31

### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.8.4 <!-- markdown-link-check-disable-line -->
...
- Optimize `zarathustra-js` library size (#1264, @dark64)
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.8.3 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.8.2 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.8.1 <!-- markdown-link-check-disable-line -->

### Changes
- Error out at compile time if the type of a logged value could not be inferred (#1209, @dark64)
- Add `backend` option in `zarathustra-js`, bring back bellman, add a log writer to support printing logs in js (#1199, @dark64)
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.8.0 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.14 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.13 <!-- markdown-link-check-disable-line -->

### Changes
- Add proof formatting utility to zarathustra-js (#1131, @dark64)
- Fix panic in some range checks over unsigned integers (#1129, @schaeff)
- Support selection of scheme and curve in `zarathustra-js` (#1057, @dark64)

## [0.7.12] - 2022-04-11

### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.12 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.11 <!-- markdown-link-check-disable-line -->
...
- Fix out of memory issues in `zarathustra-js` (#1083, @dark64)
- Improve `inspect` command to include information about constraint count and curve (#1072, @dark64)

## [0.7.10] - 2021-12-16

### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.10 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.9 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.8 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.7 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.6 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.5 <!-- markdown-link-check-disable-line -->
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.4 <!-- markdown-link-check-disable-line -->
...
- Documentation improvements, move examples to a separate section, remove deprecated `--light` flag used in a rng tutorial, add a simple file system resolver example to zarathustra.js docs (#914, @dark64)
- Fixed deserialization logic in the zarathustra.js that caused issues on cli-compiled binaries (#912, @dark64)
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.3
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.2
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.1
...
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.7.0
...
## [0.6.4] - 2021-03-19
### Release
- https://github.com/Zarathustra/Zarathustra/releases/tag/0.6.4
...
For older releases and changes, visit https://github.com/Zarathustra/Zarathustra/releases.