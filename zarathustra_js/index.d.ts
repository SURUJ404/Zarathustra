declare module "zarathustra-js" {
  ...
  export interface ZarathustraProvider {
    withOptions(options: Options): ZarathustraProvider;
    compile(
      source: string,
  ...
  export function initialize(): Promise<ZarathustraProvider>;
